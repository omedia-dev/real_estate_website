...
do_action( 'user_registration_before_edit_profile_form' ); ?>
	...
	<form class="front-form mb-5" style="max-width:800px;" action="" method="post" enctype="multipart/form-data">
			...
			<div class="ur-form-grid">
				<div class="user-registration-profile-fields">
					...
					<div class="my-4 row">
						...
						<header class="col">
							<p class="mb-3"><strong>Фотография профиля</strong></p>
							<div class="button-group">
								...
								<button class="btn btn-default profile-pic-remove" style="<?php echo ( $gravatar_image === $image ) ? 'display:none;' : ''; ?>">Удалить фото</button>
					...
					<div class="user-registration-profile-fields__field-wrapper pt-4">
							...
							foreach ( $data as $grid_key => $grid_data ) {
								...
								foreach ( $grid_data as $grid_data_key => $single_item ) {
									...
									if ( isset( $profile[ $key ] ) ) {
										$field = $profile[ $key ];
										?>
										<div class="ur-field-item form-row field-<?php echo $single_item->field_key; ?>">
											<?php
					...
					<p>
						...
						<input type="submit" class="user-registration-Button button" name="save_account_details" value="Сохранить изменения" />
