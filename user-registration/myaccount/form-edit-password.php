...
?>
	<form class="front-form mb-5" style="max-width:800px;" action="" method="post" data-enable-strength-password="<?php echo $enable_strong_password; ?>" data-minimum-password-strength="<?php echo $minimum_password_strength; ?>" >
		<div class="ur-form-row">
			<div class="ur-form-grid">
				...
				?>
				<fieldset>
					<legend class="h2 mb-4">Сменить пароль</legend>
				...
				<p>
					...
					<input type="submit" class="user-registration-Button button" name="save_change_password" value="Сменить пароль" />
