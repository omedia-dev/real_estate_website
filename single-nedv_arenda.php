...
<div class="container inner-page">
    ...
    <div class="swiper-container main-slider" id="mainDomSlider">
        ...
        <?php if( get_field('dom-gallery-type') == "upload" ): ?>
            ...
            <?php endforeach; ?>
        <?php endif; ?>
        <?php if( get_field('dom-gallery-type') == "url" ) : ?>
    ...
    <div class="object-header d-flex justify-content-between">
        <h1 class="object-title"><?php the_field('dom-title'); ?></h1>
        <?php if (get_field('dom-price')) : ?>
            <div class="price">
                <?php echo number_format ( (int)get_field('dom-price'), 0, ",", " " ); ?> <span class="currency">руб/<?php the_field('dom-period'); ?></span>
            </div> <!-- //.price -->
        <?php endif ?>
    </div> <!-- //.object-header -->
    ...
    <div class="object-location">
        <p>
            ...
            <?php
            //Адрес
            $line2Text = get_field('dom-locality-name') . " " . get_field('dom-address') . "<br>";
            echo $line2Text;
    ...
    <?php 
        ...
        if( in_array( mb_strtolower( get_field('dom-type') ), array("дом", "таунхаус", "участок", "коттедж") ) ) {
