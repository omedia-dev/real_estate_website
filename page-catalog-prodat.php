...
/**
 * Template Name: Продать недвижимость
 *
...
<div class="container inner-page">
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Продать недвижимость</li>
    </ol>
  </nav>

  <h1 class="page-title">Продать недвижимость</h1>
    ...
    <nav>
      <div class="nav nav-tabs" role="tablist">
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          ...
          <a class="nav-item nav-link active" id="nav-sdavat-tab" href="/prodat-nedvizhimost/" role="tab" aria-controls="nav-sdavat" aria-selected="false">Продать</a>
  ...
  <section class="section-catalog-order row">
    <div class="col-12 mb-2 mt-5"></div>
    <div class="col-12 col-lg-9">
      <h3 class="section-title">Воспользуйтесь услугой <a href="/wp-content/uploads/2019/09/turboprodazha.pdf" class="link-underline" target="_blank"><span>ТУРБО - ПРОДАЖА</span></a> <br>или просто заполните форму ниже.</h3>
    </div>
    <div class="col-12 col-lg-3">
      <a href="/documents/turboprodazha.pdf" class="btn btn-default frdcatalog-butt" target="_blank">Турбо-продажа</a>
    </div>
  </section>
  <div class="my-5">
    <?php echo (do_shortcode('[contact-form-7 id="238" title="Продать/Арендовать недвижимость" from="Продать неджвижимость"]')); ?>
  </div>
  ...
  <!-- <section class="section-objects catalog-section">
        <h2 class="section-title">Последние проданные объекты</h2>
        <div class="row">
