...
<div class="container inner-page">
  ...
  <section class="section-catalog-filter">
    <form action="" class="filter-form" method="GET">
      ...
      <div class="col-md-2">
          <select name="posts" class="custom-select">
        ...
        <div class="col-md-2">
          <select name="type" class="custom-select">
            <option value="0" <?php if($filter_type == 1) echo 'selected'; ?>>Недвижимость</option>
            ...
            <option value="3" <?php if($filter_type == 3) echo 'selected'; ?>>Участок</option>
          </select>
        </div> <!-- //.col -->
        <div class="col-md-2">
        ...
        <div class="col-md-2">
          <select name="rooms" class="custom-select" <?php if($filter_type != 1 && $filter_type != 0) echo 'disabled'; ?>>
            <option value="" hidden disabled <?php if($filter_flat == 0) echo 'selected'; ?>>Комн.</option>
